...
function resyncFlow(options) {
    return __awaiter(this, void 0, void 0, function () {
        var spinner, formData, requestOptions, requestUrl, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spinner = (0, ora_1.default)({ text: "Resyncing.." });
                    spinner.start();
                    formData = getResyncRequestFormData(options);
                    requestOptions = {
                        method: "POST",
                        body: formData,
                    ...
                    requestUrl = "/v2/apidocs/".concat(options.apiReferenceId, "/resync/").concat(options.userId);
                    if (options.publish) {
...
exports.default = resyncFlow;
function getResyncRequestFormData(options) {
    var _a;
    ...
    formData.append("operationType", models_1.ApiReferenceOperationType.Resync);
...
function handleResyncResponse(response) {
    var _a, _b, _c;
    if (response === null || response === void 0 ? void 0 : response.success) {
        ...
        if (importErrors == null && importWarnings == null) {
            (0, consoleWrapper_1.success)("Resync Successful!");
        }
            ...
            (0, consoleWrapper_1.error)("Resync failed! We found ".concat(importWarnings.length, " alert(s) and ").concat(importErrors.length, " errors. You can use --force to force import your spec file"));
            if (isServersAvailable == false) {
                showServerUnAwailableWarning(false);
            }
        }
        else if (importWarnings.length > 0) {
            (0, consoleWrapper_1.error)("Resync failed! We found ".concat(importWarnings.length, " alert(s). You can use --force to force import your spec file"));
            if (isServersAvailable == false) {
                showServerUnAwailableWarning(false);
            }
        }
        else if (importErrors.length > 0) {
            (0, consoleWrapper_1.error)("Resync failed! We found ".concat(importErrors.length, " errors. You can use --force to force import your spec file"));
            if (isServersAvailable == false) {
                showServerUnAwailableWarning(false);
            }
        }
...
function showServerUnAwailableWarning(withForceInfo) {
    if (withForceInfo) {
        (0, consoleWrapper_1.warning)("You may not be able to use try-it feature. Looks like server variables aren’t defined in your OpenAPI Specification file. You can use --force to force import your spec file");
    }
    else {
