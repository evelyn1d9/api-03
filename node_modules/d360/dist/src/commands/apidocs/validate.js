...
var validate_1 = __importDefault(require("../../api/apidocs/validate"));
var ValidateCommand = /** @class */ (function (_super) {
    __extends(ValidateCommand, _super);
    function ValidateCommand() {
        var _this = _super.call(this) || this;
        _this.command = "apidocs:validate";
        _this.description = "Validate your OpenAPI definition file";
        _this.commandCategory = constants_1.CommandCategories.apidocs;
        _this.usage = "apidocs:validate [options]";
        _this.args = [
            {
                name: "apiKey",
                type: String,
    ...
    ValidateCommand.prototype.run = function (options) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!!options.path) return [3 /*break*/, 3];
                        _a = options;
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, validate_1.default)(options)];
                    case 4:
                        _b.sent();
